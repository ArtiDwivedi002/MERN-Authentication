...
<form onSubmit={onSubmitHandler}> 
  {state === 'Sign Up' && ( <div className='mt-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
    <img src={assets.person_icon} alt=''/>
    <input  onChange={e=>setName(e.target.value)} value={name}
    className='bg-transparent outline-none' type='text' placeholder='Full Name' required/> 
  </div>
)}
    <div className='mt-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
